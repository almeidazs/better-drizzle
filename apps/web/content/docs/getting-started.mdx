...
icon: Rocket
seoTitle: 'Getting Started - Drizzle ORM Quick Start'
seoDescription: 'Install better-drizzle, wrap your Drizzle ORM client, and run your first type-safe findMany, create, and relation queries on PostgreSQL, MySQL, or SQLite.'
---
