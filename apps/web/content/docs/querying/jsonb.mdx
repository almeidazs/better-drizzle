---
title: JSONB filters
description: PostgreSQL JSONB queries through concise dot-path predicates, generated from your column's TypeScript shape.
icon: Braces
seoTitle: 'PostgreSQL JSONB Filters for Drizzle ORM'
seoDescription: 'Query PostgreSQL JSONB columns in Drizzle ORM with concise dot-path predicates and index-friendly SQL, while preserving the typed legacy wrapper.'
---
