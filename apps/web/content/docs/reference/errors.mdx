...
seoDescription: 'Cross-dialect helpers to detect unique, foreign key, and not-null constraint violations and normalize database errors from Drizzle ORM drivers.'
---
