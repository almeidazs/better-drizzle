...
seoDescription: 'Every method on a better-drizzle table delegate: findMany, findUnique, create, update, upsert, delete, paginate, cursor, count, and batch operations.'
---
