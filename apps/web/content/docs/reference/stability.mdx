...
icon: ShieldCheck
seoTitle: 'Stability & Semver Policy'
seoDescription: 'What better-drizzle considers stable in the 0.2.x line, how the unified package is versioned, and what counts as a breaking change.'
---
