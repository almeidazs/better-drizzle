...
icon: Plug
seoTitle: 'Drizzle ORM with Next.js, Express & Fastify'
seoDescription: 'Set up better-drizzle and Drizzle ORM in Next.js, Bun, Express, and Fastify apps: where the client lives and how requests use it.'
---
