...
icon: Boxes
seoTitle: 'Service Layer & Repository Pattern'
seoDescription: 'Keep service layers thin and explicit with the repository pattern on top of Drizzle ORM: typed reads, writes, transactional services, and what to avoid.'
---
