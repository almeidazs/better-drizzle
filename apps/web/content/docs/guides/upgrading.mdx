...
icon: ArrowUpCircle
seoTitle: 'Upgrading to better-drizzle 0.2'
seoDescription: 'Migrate from the scoped @better-drizzle/* plugin packages to the unified better-drizzle 0.2 package with subpath exports for every plugin.'
---
