...
icon: ArrowRightLeft
seoTitle: 'Migrating from Raw Drizzle ORM Queries'
seoDescription: 'Incrementally replace hand-written Drizzle ORM query glue with typed repository delegates, keeping raw Drizzle for the queries that need it.'
---
...
const [inserted] = await db
	...
	.returning();
const maybeCreated = inserted ?? null;
```
