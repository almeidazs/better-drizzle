...
seoDescription: 'First-party better-drizzle skill pack for AI coding agents that read AGENTS.md and SKILL.md, with a zero-scripts, zero-network security model.'
---
